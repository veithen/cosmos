...
public class GetActivatorTest {
    ...
    public void test() throws Exception {
        ...
        Method getActivatorMethod = InitLegacyPreferences.class.getDeclaredMethod("getActivator", String.class);
        getActivatorMethod.setAccessible(true);
        Plugin plugin = (Plugin)getActivatorMethod.invoke(new InitLegacyPreferences(), "eclipse-core-runtime-test");
