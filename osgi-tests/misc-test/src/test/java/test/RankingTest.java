...
public class RankingTest {
    ...
    @Test
    public void test() {
        ServiceReference<MyService> serviceRef1 = bundleContext.registerService(MyService.class, new MyServiceImpl(), null).getReference();

        Hashtable<String, Object> props2 = new Hashtable<>();
        props2.put(Constants.SERVICE_RANKING, 10);
        ServiceReference<MyService> serviceRef2 = bundleContext.registerService(MyService.class, new MyServiceImpl(), props2).getReference();

        Hashtable<String, Object> props3 = new Hashtable<>();
        props3.put(Constants.SERVICE_RANKING, -10);
        ServiceReference<MyService> serviceRef3 = bundleContext.registerService(MyService.class, new MyServiceImpl(), props3).getReference();

        ServiceReference<MyService> serviceRef4 = bundleContext.registerService(MyService.class, new MyServiceImpl(), null).getReference();
