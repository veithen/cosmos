 ...
 * possible:
 * <ul>
 * <li>{@link #LOADED} &rarr; {@link #READY} and {@link #LAZY_ACTIVATE} &rarr; {@link #ACTIVE}: This
 * transition occurs when a depending bundle is activated. This allows the framework to emulate
 * lazy activation (Since it doesn't have control over the class loader, it cannot fully implement
 * this feature).
...
enum BundleState {
     ...
     * dependencies (including transitive dependencies) are in state {@link #READY} or
     * {@link #ACTIVE}.
     */
